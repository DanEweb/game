export const MAPS = {
    field: {
      ...
      bosses:['oseojin','parktaeyoung','wonGeun','minGi','seulgi','monday','overtime'],
    ...
    archive: {
      ...
      bosses:['byungWoo','jiEun','eunJae','yuJinKong','jungWoo','deadline','rentday'],
    ...
    abyss: {
      ...
      bosses:['seonJeong','spaceStar','nukNukEX','goDokGeun','monday','deadline','aiface'],
