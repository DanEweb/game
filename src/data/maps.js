export const MAPS = {
    field: {
      ...
      bosses:['oseojin','parktaeyoung','wonGeun','minGi','seulgi','monday'],
    ...
    archive: {
      ...
      bosses:['byungWoo','jiEun','eunJae','yuJinKong','jungWoo','deadline'],
    ...
    abyss: {
      ...
      bosses:['seonJeong','spaceStar','nukNukEX','goDokGeun','monday','deadline'],
